    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${list}" var="i">
            <tr>
                ...
                <td>${i.qq}</td>
                <td>${i.email}</td>
                <td><a class="btn btn-default btn-sm" href="/demo05?id=${i.id}">修改</a>&nbsp;
                    <a class="btn btn-default btn-sm" href="javascript:void(0)" onclick="f(this,${i.id})">删除</a></td>
            </tr>
